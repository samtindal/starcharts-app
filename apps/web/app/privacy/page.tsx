...
export default function Privacy() {
  return (
    <div className="prose">
      ...
      <ul>
        <li>
          <b>Product analytics</b>: Google Analytics (GA4), recording anonymous, aggregate events such as a planet
          drag starting, the clock jumping to a new date, an aspect being tapped, or a page view. Used to
          understand which parts of the site are useful, not to build a profile of any one visitor. See
          Google&rsquo;s{' '}
