...
export default function Wheel({ initialMs }: { initialMs: number }) {
  ...
  // bounded to the ring's own band (aspect line at r=240 to the inner boundary
  // circle at r=246); nudging further in used to drop crowded planets past the
  // ring and into the aspect mesh near center.
