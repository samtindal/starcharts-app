...
- MCP: DEFERRED out of v1 (server paused, not launching in P1, owner decision 2026-07-12); revisit when the service resumes. Then: schema validation, rate-limit behavior, key auth, response parity with astro-core.
- Privacy/consent (once ads ship, E4): non-essential cookies stay off for EU/UK visitors before consent; `/privacy` linked sitewide.
